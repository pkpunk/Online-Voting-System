				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
								...
								<a href="dashboard.php?page=home" data-toggle="modal" class="btn btn-flat btn-primary btn-lg">View Election</a>
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										if ($currentdate < $start || $end < $currentdate) {
											continue;
										}*/
												...
												<div class="col-xs-12">
													<div class="box box-solid" id="'.$row['id'].'">
														<div class="box-header with-border">
															...
															<h5 class="label label-info">Voting Starts : ' . $row['start_date'] . '</h5><h5 class="label label-danger"> Voting Ends : ' . $row['end_date'] . ' </h5>
														</div>
														<div class="box-body">
															<p>'.$instruct.'
